...
## Instructions:
1. Run the command **python __init__.py** in your terminal.
2. Enter the number of players you want to play the game.
3. Follow the instruction as shown in terminal.
